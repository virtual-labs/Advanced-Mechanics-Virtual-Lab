...
var IMG_INDX, CENTER, right_click, left_click;
...
var needle_last_y, right_rotation, left_rotation, zoom_rooler_initial_y, initial_breadth;

var lense_down_initial, lense_up_initial, needle_zoom_y, rotation;

var initial_pin_position, pin_distance_from_equation, microscope_forward_adjust_dist, microscope_backward_adjust_dist;
...
function directiveFunction(){
	return {
		...
		link: function(scope, element,attrs){
			...
			/** Add all the strings used for the language translation here. '_' is the short cut 
...
function loadImagesMin(name){
    ...
    _bitmap.alpha = 1;   
    _bitmap.cursor = "";
    if ( name == "ruler_steel" || name == "ruler_copper" || name == "ruler_aluminium" || name == 'ruler_wood' || name == 'ruler_over_material' ) {
...
function initialisationOfVariables() {
   ...
   CENTER = 272; /** Center point of balde edges */
   ...
   right_rotation = left_rotation = 0; /** Iinitia value of scale moved count */
   ...
   initial_pin_position = -20;
   pin_distance_from_equation = 0;
   microscope_forward_adjust_dist = 0;
   microscope_backward_adjust_dist = 0;
}